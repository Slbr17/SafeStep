...
const styles = StyleSheet.create({
  ...
  addBtn: { backgroundColor: '#208AEF', borderRadius: 10, width: 44, alignItems: 'center', justifyContent: 'center' },
  ...
  avatar: { width: 44, height: 44, borderRadius: 22, backgroundColor: '#208AEF', alignItems: 'center', justifyContent: 'center' },
